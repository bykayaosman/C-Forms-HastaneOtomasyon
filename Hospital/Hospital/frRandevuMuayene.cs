...
namespace Hospital
{
    public partial class frRandevuMuayene : Form
    {
        public frRandevuMuayene()
        {
            InitializeComponent();
        }
        ...
        private void frRandevuMuayene_Load(object sender, EventArgs e)
        {
            try
            {
                maskedTextBox4.Text = frDoktorRandevuGoruntule.hastaid;
                doktorBilgiler();
                hastaBilgiler();
                testler();
            }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    baglanti.Open();
                    SqlCommand temizle = new SqlCommand("delete from randevular where randevu_hasta_id=@id ", baglanti);
